...
LPC_PWRD_API -> set_fro_frequency(30000);
	...
	init_lcd();
	sprintf(texte, "%s", "Accompagnement_2  ");
	lcd_puts(texte);
...
void play_chords(int number){
	...
	char music_length[1] = { 56 };
	char music_melody[1][100] = {
	        { 'S','B','B','A','S','B','B','A','E','A','F',
	          'S','B','A','B','S','B','B','A','S','B','B',
			  'A','E','A','F','S','B','A','B'
	        }
	...
	char music_rythm[1][100] = {
	    { 2,7,5,2,2,4,4,4,6,4,4,2,4,4,6,
	      5,8,5,2,2,4,4,4,6,4,4,2,4,4,6
	      }
	    };
